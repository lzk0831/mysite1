...
const zo = {
    ...
    tl = {
        ...
        setup(e) {
            const t = oi([{
                name: "小兔主用导航",
                url: "https://luolitu.cn/",
                status: "检测中"
            }, {
                name: "小兔互联",
                url: "https://hl.luoltu.com",
                status: "检测中"
            }, {
                name: "小兔宝塔主机",
                url: "https://bt.luoltu.com",
                status: "检测中"
            }, {
                name: "小兔码支付",
                url: "https://pay.lltu.net",
                status: "检测中"
            }, {
                name: "小兔建站免费版",
                url: "https://luoli520.cn",
                status: "检测中"
            }, {
                name: "小兔建站正式版",
                url: "https://jz.luoltu.com",
                status: "检测中"
            }, {
                name: "小兔社区",
                url: "https://loli520.com",
                status: "检测中"
            }]);
            t.value.forEach((s) => {
